...
- Automatically downloads a streaming English Zipformer-Transducer model into `<repo>/models/` by default.
...
2. Download and extract the model to `<repo>/models/`.
...
- To force re-download, delete `<repo>/models/` and run again.
